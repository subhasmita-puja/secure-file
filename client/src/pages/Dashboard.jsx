...
const getPageFromPath = () =>
  window.location.pathname.startsWith("/shared-files")
    ? "shared-files"
    : "my-files";
...
function Dashboard({ onLogout }) {
  ...
  const navigateToPage = (page) => {
    ...
    const path =
      page === "shared-files" ? "/shared-files" : "/my-files";
...
const previewableFiles = loadedFiles.filter((file) => {
  ...
  const validateFile = (file) => {
    ...
    if (file.size > MAX_FILE_SIZE) {
      return "File size must not exceed 100 MB.";
    }
  ...
  const handleToggleVisibility = async (fileId) => {
    try {
      ...
      setError(
        error.response?.data?.message ||
          "Unable to change file visibility."
      );
  ...
  const handleCopyShareLink = async (file) => {
    if (!file.shareToken) {
      setError(
        "Share link is unavailable for this file."
      );
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#03050d] text-slate-200 font-sans">
      ...
      <div
        ref={headerRef}
        className="relative z-10 lg:pl-[260px]"
      >
            ...
            <div className="mb-8 flex items-center gap-3 rounded-xl border border-red-500/30 bg-red-950/40 p-4 text-sm text-red-300 backdrop-blur-md shadow-lg shadow-red-900/20">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M12 9v3.75m0 3h.008M10.29 3.86l-7.5 13A1.5 1.5 0 004.09 19h15.82a1.5 1.5 0 001.3-2.25l-7.5-13a1.5 1.5 0 00-2.6 0z"
                />
              </svg>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-sm rounded-2xl border border-red-500/20 bg-[#0a1220] p-6 shadow-2xl shadow-red-950/40">
            ...
            <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl border border-red-500/30 bg-red-500/10 text-red-400">
              ...
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth={2}
                  d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 01-1-1h-4a1 1 0 00-1 1v3M4 7h16"
                />
              </svg>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button
                onClick={cancelDelete}
                className="flex-1 rounded-xl border border-slate-700 px-4 py-2.5 text-sm font-bold text-slate-300 transition-colors hover:bg-slate-800/60"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="flex-1 rounded-xl border border-red-500/30 bg-red-500/15 px-4 py-2.5 text-sm font-bold text-red-300 transition-colors hover:bg-red-500/25"
              >
                Delete
              </button>
